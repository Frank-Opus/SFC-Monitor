...
async function sendConfirmationEmail(email, referralCode) {
  ...
  const shareText = encodeURIComponent('I just joined the SFC-Monitor waitlist — real-time global intelligence powered by AI. Join me:');
  ...
  const telegramShare = `https://t.me/share/url?url=${shareUrl}&text=${encodeURIComponent('Join the SFC-Monitor waitlist:')}`;
  ...
  try {
    const resendRes = await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        from: 'SFC-Monitor <noreply@worldmonitor.app>',
        to: [email],
        subject: 'You\u2019re on the SFC-Monitor waitlist',
        html: `
          <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: 600px; margin: 0 auto; background: #0a0a0a; color: #e0e0e0;">
              ...
              <table cellpadding="0" cellspacing="0" border="0" style="margin: 0 auto 32px;">
                <tr>
                  ...
                  <td style="padding-left: 12px;">
                    <div style="font-size: 16px; font-weight: 800; color: #fff; letter-spacing: -0.5px;">SFC-MONITOR</div>
                    <div style="font-size: 10px; color: #666; text-transform: uppercase; letter-spacing: 2px;">SFC</div>
                  </td>
                </tr>
              </table>
            ...
            <div style="border-top: 1px solid #1a1a1a; padding: 24px 32px; text-align: center;">
              <div style="margin-bottom: 16px;">
                <a href="https://github.com/koala73" style="color: #666; text-decoration: none; font-size: 12px; margin: 0 12px;">GitHub</a>
              ...
              <p style="font-size: 11px; color: #444; margin: 0; line-height: 1.6;">
                SFC-Monitor — Real-time intelligence for a connected world.<br />

...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  full: {
    title: 'SFC-Command Center - Real-Time Global Intelligence Dashboard',
    ...
    siteName: 'SFC-Command Center',
    shortName: 'SFC-Command Center',
    subject: 'Real-Time Global Intelligence and Command Awareness',

...
export const COMMANDS: Command[] = [
  ...
  { id: 'panel:polymarket', keywords: ['predictions', 'polymarket', 'sfc-agent ai predictions', 'forecasts'], label: 'Panel: SFC-Agent AI Predictions', icon: '\u{1F52E}', category: 'panels' },
  ...
  { id: 'panel:market-implications', keywords: ['market implications', 'trade signals', 'ai signals', 'sfc-agent ai', 'long short hedge', 'trade thesis'], label: 'Panel: SFC-Agent AI Market Implications', icon: '\u{1F4CA}', category: 'panels' },
  ...
  { id: 'panel:insights', keywords: ['insights', 'ai insights', 'sfc-agent ai insights', 'analysis'], label: 'Panel: SFC-Agent AI Insights', icon: '\u{1F4A1}', category: 'panels' },
  { id: 'panel:strategic-posture', keywords: ['strategic posture', 'ai posture', 'sfc-agent ai posture', 'posture assessment'], label: 'Panel: SFC-Agent AI Strategic Posture', icon: '\u{1F3AF}', category: 'panels' },
  { id: 'panel:forecast', keywords: ['forecast', 'ai forecast', 'sfc-agent ai forecast', 'predictions ai'], label: 'Panel: SFC-Agent AI Forecasts', icon: '\u{1F52E}', category: 'panels' },
